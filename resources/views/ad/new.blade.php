    ...
    <div class="container">
        ...
        <form action="{{route('ads.store')}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" value="{{old('title')}}" placeholder="Taper un super titre pour votre annonce"
            ...
            <div class="form-group">
                ...
                <input type="text" name="cover_image" value="{{old('cover_image')}}" placeholder="Donnez l'adresse d'une image qui vous donne envie"
            ...
            <div class="form-group">
                ...
                <textarea placeholder="Donner une description globale de l'annonce" class="form-control @error('introduction') is-invalid @enderror" name="introduction"
                          id="intro">{{old('introduction')}}</textarea>
                @error('introduction')
                <p class="error">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea placeholder="Donner une description qui vous donne envie de revenir chez vous" class="form-control @error('content') is-invalid @enderror" name="content"
                          id="contenu">{{old('content')}}</textarea>
                @error('content')
                <p class="error">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{old('rooms')}}" placeholder="Le nombre de chambre disponible" class="form-control @error('rooms') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" value="{{old('price')}}" placeholder="Indiquez le prix que vous voulez pour une nuit"
                        ...
                        <div class="form-group" id="block_{{$loop->index}}">
                            <div class="row">
                                <div class="col-10">
                                    <div class="row">
                                        <div class="col">
                                            <input placeholder="URL de l'annonce" value="{{ $image['url'] }}"
